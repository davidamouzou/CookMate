...
export function AddEntry({ locale, open, onClose, onAdd }: AddEntryProps) {
    ...
    return (
        <div className="sticky bottom-[calc(env(safe-area-inset-bottom)+5rem)] z-40 lg:bottom-4">
            <div className="rounded-2xl bg-surface-inverted p-4 text-surface-inverted-foreground shadow-lifted">
                <div className="mb-3 flex items-start justify-between gap-3">
                    ...
                    <button
                        ...
                        className="tap rounded-full p-1 opacity-60 transition-opacity hover:opacity-100 focus-visible:outline-none focus-visible:ring-2 focus-visible:ring-white/60"
                    >
                ...
                {lastMeal ? (
                    <p className="mb-3 font-mono text-meta leading-snug opacity-60 tabular">
                ...
                {error ? (
                    <p className="mb-3 font-mono text-meta text-track-coral-ink" role="alert">
                        {error}
                    </p>
                ) : null}
                ...
                <div className="flex items-end gap-2 border-t border-white/10 pt-3">
                    ...
                    <button
                        ...
                        className={cn(
                            "tap inline-flex h-8 w-8 shrink-0 items-center justify-center rounded-full",
